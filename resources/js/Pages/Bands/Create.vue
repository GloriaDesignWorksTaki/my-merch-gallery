      ...
      <form @submit.prevent="submit" class="glass-surface space-y-6 p-5 sm:p-6">
        ...
        <div>
          ...
          <input
            ...
            class="mt-1 block w-full text-base text-slate-600 file:mr-3 file:rounded-xl file:border-0 file:bg-white/70 file:px-4 file:py-2 file:text-base file:font-medium file:text-slate-700 hover:file:bg-white md:text-sm md:file:text-sm"
